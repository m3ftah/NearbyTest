...
public class CController {
    ...
    public CController(Activity activity) {
        this.socketController = new SocketController(this,activity);
        this.cLifecycleCtrl = new ConnectionLifecycleController(socketController);
        this.endpointDiscoveryCtrl = new EndpointDiscoveryController(socketController);
        this.payloadController = new PayloadController(socketController);
    }
    ...
    public void disconnect(String endpointId) {
        this.cLifecycleCtrl.onDisconnected(endpointId);
